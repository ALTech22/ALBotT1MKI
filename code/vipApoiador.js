...
module.exports = async (client,msg) => {
    ...
    .addFields(
        ...
        {name: "Vantagens", value: "Cores no tab & Cores no chat & Tag especial [VIPApoiador] & Um chapéu lindo com /hat & Ganha uma mochila pequena lindissima e uma chave para abri-la &  15 Homes (10 a mais que os não vips) & Pode desativar o pvp & Acesso ao /vip & 50k de money & 6 Blocos de diamantes & 6 Blocos de esmeralda & 6 Blocos de ouro"},
