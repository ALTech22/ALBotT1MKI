...
module.exports = async (client,msg) => {
    ...
    .addFields(
        ...
        {name: "Vantagens", value: "Mesmas coisas que o vip apoiador & Efeitos no chat com &k, &l, etc & Pode criar lojas & Pode criar mochilas & Pode voar com o /voar e parar de voar com o /parardevoar & Tag especial [VIPSupreme] & 15 Homes (5 mais que os apoiadores e 10 a mais que os não vips) & 75k de money & 16 blocos de diamantes & 16 blocos de esmeralda"},
